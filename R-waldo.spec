...
Version  : 0.6.2
Release  : 35
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/waldo_0.6.2.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/waldo_0.6.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752503776
...
/usr/lib64/R/library/waldo/tests/testthat/_snaps/num_equal.md
