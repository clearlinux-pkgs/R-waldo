...
Version  : 0.2.5
Release  : 6
URL      : https://cran.r-project.org/src/contrib/waldo_0.2.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/waldo_0.2.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615232959
